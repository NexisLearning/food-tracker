...
final class TelegramWebhookPayloads
{
     ...
     * @return array<string, mixed>
     */
    public static function callbackQuery(string $action, int $approvalIndex = 0, string $chatId = '123456789', int $messageId = 100): array
    {
        return [
            'callback_query' => [
                'id' => 99,
                ...
                'data' => sprintf('action:%s;i:%d', $action, $approvalIndex),
            ],
        ];
    }
}
