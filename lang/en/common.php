...
return [
    ...
    'snap_to_track' => [
        ...
        'review' => [
            ...
            'ai_confidence' => 'AI confidence: {{confidence}}%. Every value below is editable.',
            'items_heading' => 'Detected items',
            'item_name' => 'Food item',
            'portion' => 'Portion',
            'calories' => 'Calories',
            'protein' => 'Protein (g)',
            'carbs' => 'Carbs (g)',
            'fat' => 'Fat (g)',
            'reference_badge' => 'Matched against USDA reference data',
            'add_item' => 'Add item',
            'remove_item' => 'Remove item',
            'totals' => 'Meal totals',
            'meal_time' => 'When did you eat this?',
            'notes' => 'Notes',
            'notes_placeholder' => 'Optional — name this meal or add context',
            'disclaimer' => 'These values are AI estimates and are not suitable for medication or insulin-dosing decisions.',
            'save' => 'Log this meal',
            'saving' => 'Logging…',
        ],
        'unavailable' => [
            'heading' => 'This meal draft is no longer available',
            'expired' => 'Drafts expire 60 minutes after analysis to protect your privacy. Analyze another photo to pick up where you left off.',
            'consumed' => 'This meal has already been saved to your logbook.',
            'generic' => 'We could not find this draft. Analyze another photo to continue.',
            'analyze_again' => 'Analyze another photo',
        ],
        'index' => [
            'heading' => 'Analyze a meal photo',
            'description' => 'Snap or upload one photo — the AI estimates calories, protein, carbs, and fat for every item. You review before anything is saved.',
            'upload_label' => 'Meal photo',
            'analyze' => 'Analyze photo',
            'analyzing' => 'Analyzing…',
            'saved_heading' => 'Meal logged!',
            'saved_description' => 'Your reviewed meal is now part of your health history.',
            'open_entry' => 'Open your logbook',
        ],
    ],
    'sidebar' => [
